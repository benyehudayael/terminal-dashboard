...
export class DataService {
  ...
  getFlights(delay: number, scopeInMinutes: number): Observable<FlightSummary[]> {
    return this.http.get<object[]>('https://localhost:7261/api/flight?delay=' + delay + '&scopeInMinutes=' + scopeInMinutes)
